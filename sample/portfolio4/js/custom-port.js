$(document).ready(function(){
	...
	$("section").on("mousemove",function(e){		
		...
		$(".p12").css({"left":200+(posX/20) , "bottom":-40+(posY/20) });
		$(".p13").css({"right":60+(posX/20) , "top":180+(posY/20) });		
	
		//두 번째 박스의 이미지 위치값을 마우스 커서의 위치값과 연동
		$(".p21").css({"right":50-(posX/30) , "bottom":50-(posY/30) });
		$(".p22").css({"right":-40+(posX/50) , "top":-40+(posY/50) });
		
		//세 번째 박스의 이미지 위치값을 마우스 커서의 위치값과 연동
		$(".p31").css({"right":0-(posX/30) , "bottom":30-(posY/30) });
		$(".p32").css({"right":-90+(posX/20) , "bottom":-270+(posY/20) });
		$(".p33").css({"right":-70+(posX/20) , "bottom":-130+(posY/20) });	
		
		//네 번째 박스의 이미지 위치값을 마우스 커서의 위치값과 연동
		$(".p41").css({"right":-50-(posX/30) , "bottom":20-(posY/30) });
		$(".p42").css({"right":250+(posX/20) , "bottom":-180+(posY/20) });	

		$(".p51").css({"right":50-(posX/30) , "bottom":180-(posY/30) });
		$(".p52").css({"right":-40+(posX/50) , "top":-100+(posY/50) });

		$(".p61").css({"right":-40+(posX/30) , "bottom":0+(posY/30) });
		$(".p62").css({"left":-60+(posX/20) , "bottom":-40+(posY/20) });
		$(".p63").css({"right":60+(posX/20) , "top":180+(posY/20) });		
